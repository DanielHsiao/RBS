...
Split(['#twelve', '#thirteen'], {
    ...
    gutterStyle: function (dimension, gutterSize) {
        return { 'flex-basis':  gutterSize + 'px' }
          ...
          <h5>API</h5>
          <hr>
          <p>Use the returned instance to access two methods that control the split: <b>setSizes</b> and <b>collapse</b>, a method for getting the current sizes: <b>getSizes</b> and a method for destroying the split: <b>destroy</b>.</p>
...
instance.destroy();  // Destroy</code></pre>
          ...
          <div>
            ...
            <button onclick="console.log(instance.getSizes())">Get Sizes</button>
